...
class DailyEntryPage extends Component {
    ...
    addItemToDailyList(meal) {
        ...
        var link='https://api.nal.usda.gov/ndb/nutrients/?format=json&api_key=INSERT USDA API KEY HERE&ndbno=' + this.state.selectedItem.ndbno + '&nutrients=208&nutrients=203&nutrients=204&nutrients=205';
        fetch(link).then(function(response) {
            return response.json();
        }).then(function(jsonData) {
